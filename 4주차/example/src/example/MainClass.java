...
public class MainClass {
	/*
	 * 자바8의 가장 큰 변화를 "람다식"이라고 할 수 있다. 람다식? 간단한 방식으로 코드를 작성하고 실행하자!
	 */
	...
	public static void main(String[] args) {
		...
		/*
		 * 함수형 인터페이스 : 람다식의 타입으로 사용되는 하나의 추상 메소드를 가진 인터페이스.
		 */
		...
		// 정답 : BinaryOperator<Integer> add=(x, y)->x+y;
		...
		/*
		 * java.util.Consumer 임의형태의 입력값<T>을 받아 처리하고 출력은 하지 않는 형태의 인터페이스이다.
		 */
		Consumer<String> c1 = t -> System.out.println(t + "8");
		c1.accept("java");

		/*
		 * java.util.Supplier getXXX()메서드를 가지고 있음. 입력이 없고 return만 있다.
		 */
		IntSupplier is = () -> {
